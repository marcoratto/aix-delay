...
public class ComponentsTranslation {
  ...
  public static HashMap<String, String> map() {
    ...
    map.put("EVENTDESC-SleepFinishedEventDescriptions", MESSAGES.SleepFinishedEventDescriptions());
    map.put("METHODDESC-sleepMethodDescriptions", MESSAGES.sleepMethodDescriptions());
